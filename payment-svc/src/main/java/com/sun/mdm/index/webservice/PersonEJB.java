...
public interface PersonEJB {
    ...
    @WebResult(name = "return", targetNamespace = "")
    public com.sun.mdm.index.webservice.ObjectDefinition lookupObjectDefinition() throws ProcessingException_Exception, PageException_Exception, UserException_Exception;
    ...
    @WebMethod
    @Action(input = "http://webservice.index.mdm.sun.com/PersonEJB/performEmpiRecordUpdateRequest", output = "http://webservice.index.mdm.sun.com/PersonEJB/performEmpiRecordUpdateResponse", fault = {@FaultAction(className = ProcessingException_Exception.class, value = "http://webservice.index.mdm.sun.com/PersonEJB/performEmpiRecordUpdate/Fault/ProcessingException"), @FaultAction(className = UserException_Exception.class, value = "http://webservice.index.mdm.sun.com/PersonEJB/performEmpiRecordUpdate/Fault/UserException")})
    @RequestWrapper(localName = "performEmpiRecordUpdate", targetNamespace = "http://webservice.index.mdm.sun.com/", className = "com.sun.mdm.index.webservice.PerformEmpiRecordUpdate")
    @ResponseWrapper(localName = "performEmpiRecordUpdateResponse", targetNamespace = "http://webservice.index.mdm.sun.com/", className = "com.sun.mdm.index.webservice.PerformEmpiRecordUpdateResponse")
    @WebResult(name = "return", targetNamespace = "")
    public com.sun.mdm.index.webservice.MatchColResult performEmpiRecordUpdate(
        @WebParam(name = "callerInfo", targetNamespace = "")
        com.sun.mdm.index.webservice.CallerInfo callerInfo,
        @WebParam(name = "sysObjBean", targetNamespace = "")
        com.sun.mdm.index.webservice.SystemPerson sysObjBean
